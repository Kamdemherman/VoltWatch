...
class LightModeColors {
  static const lightPrimary = Color(0xFF2E7D32); // Vert énergétique
  static const lightOnPrimary = Color(0xFFFFFFFF);
  static const lightPrimaryContainer = Color(0xFFE8F5E8);
  static const lightOnPrimaryContainer = Color(0xFF1B5E20);
  static const lightSecondary = Color(0xFFFF9800); // Orange pour les alertes
  static const lightOnSecondary = Color(0xFFFFFFFF);
  static const lightTertiary = Color(0xFF1976D2); // Bleu pour les données
...
class DarkModeColors {
  static const darkPrimary = Color(0xFF81C784); // Vert clair
  static const darkOnPrimary = Color(0xFF1B5E20);
  static const darkPrimaryContainer = Color(0xFF388E3C);
  static const darkOnPrimaryContainer = Color(0xFFE8F5E8);
  static const darkSecondary = Color(0xFFFFCC02); // Orange clair
  static const darkOnSecondary = Color(0xFF663C00);
  static const darkTertiary = Color(0xFF64B5F6); // Bleu clair
  ...
  static const darkAppBarBackground = Color(0xFF388E3C);
}
